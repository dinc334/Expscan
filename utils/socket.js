...
// const TxsTokens = require('../models').TxsTokens;
// const Supplies = require('../models').Supplies;

const Web3 = require('web3');
const web3 = new Web3(new Web3.providers.HttpProvider('http://localhost:9656'))
...
var options = {
	fromBlock : 900000,
	toBlock: 'latest',
	address: contracts.tokenlab.address,
	topics: null
}


//getTokenTxs(tokenlab)

// async function getMintedTxs() {
// 	let txs = await tokenlab.getPastEvents('Mint', options)
...
async function test () {
	let data = await tokenlab.getPastEvents('Mint',options);
	console.log(result)
