...
const { Blocks, Transactions, Addresses, Supplies, TxsTokens, Contracts } = require('../models');

const formatDB = require('./ethformatter.js').formatDB;
